        ...
        <div>

            {
                cleaningSectors[0] ? <div>
                    ...
                    <div id="sectors-data" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-20">

                        {
                            cleaningSectors.map((sector) => (
                                <div className="sector-item bg-white shadow" key={sector}>
                                    <Link href={{
                                        pathname: '/products',
                                        query: { sector: sector.id },
                                    }}>
                                        <div>
                                            <Image className="h-[300px] rounded-t-lg" src={sector.image} width={500} height={500} alt={sector.id} />
                                        </div>
                                        <div className="p-4">
                                            ...
                                            <Link href={{
                                                pathname: '/products',
                                                query: { sector: sector.id },
                                            }} class="inline-flex position-absolute bottom-4 items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#581412] rounded-lg hover:bg-[#09679d] focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                                                Explore Products
