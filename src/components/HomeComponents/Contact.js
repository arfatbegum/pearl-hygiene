                ...
                <div
                    ...
                    <div class="flex flex-col text-white">
                        <div class="flex flex-col mb-4">
                            ...
                            <p class="text-gray-300"><FontAwesomeIcon icon={faLocationDot} className="mr-2" />Abdullah Al Hamathani, Near Al Harbi Market, Al Malaz District, PO Box 103218, Riyadh 11695, Kingdom of Saudi Arabia                                        </p>
                        </div>

                        <div class="flex flex-col">
                            <h2 class="text-xl uppercase mb-2">Marketing & Sales Enquiries</h2>
                            <p class="text-gray-300"><FontAwesomeIcon icon={faPhone} className="mr-2" /> <Link href='tel:+966 56 000 0342'>
                                +966 56 000 0342
                            </Link></p>
                        </div>
