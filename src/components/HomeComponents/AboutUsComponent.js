    ...
    <div data-aos="fade-left"
      ...
      <div className="lg:flex lg:gap-8 lg:px-24 px-8 justify-center items-center">
        <div className="lg:w-1/2 mb-8 lg:mb-0">
          <h1 className="text-lg font-semibold text-[#0464a0] mb-2 uppercase">
          ...
          <button className="border-2 border-[#0464a0] hover:bg-[#581412] hover:text-white hover:border-none rounded-lg px-6 py-2 text-[#0464a0]">
